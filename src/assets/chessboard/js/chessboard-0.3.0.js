        ...
        function(containerElOrId, cfg) {
            ...
            function checkDeps() {
                ...
                if (
                    !(
                        ...
                        $.fn &&
                        $.fn.jquery &&
                        compareSemVer($.fn.jquery, MINIMUM_JQUERY_VERSION) ===
                            true
                    )
                ) {
                    window.alert(
            ...
            function createElIds() {
                ...
                for (var i = 0; i < pieces.length; i++) {
                    ...
                    SPARE_PIECE_ELS_IDS[whitePiece] =
                        whitePiece + '-' + createId()
                    SPARE_PIECE_ELS_IDS[blackPiece] =
                        blackPiece + '-' + createId()
                }
            }
...
*/
            ...
            function findClosestPiece(position, piece, square) {
                ...
                for (var i = 0; i < closestSquares.length; i++) {
                    ...
                    if (
                        position.hasOwnProperty(s) === true &&
                        position[s] === piece
                    ) {
                        return s
                    }
